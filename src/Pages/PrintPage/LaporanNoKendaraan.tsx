...
export default function LaporanNoKendaraanPrint() {
    const [searchParams] = useSearchParams();
    const noKendaraan = searchParams.get("noKendaraan");
    ...
    useEffect(() => {
        const fetchData = async () => {
            if (!start || !end || !noKendaraan) return;
            setLoading(true)
            try {
            ...
            {loading ? (
                ...
                <div>
                    <div ref={contentRef} className="print:p-8">
                        ...
                        <div className="flex">
                            <p className="text-xs">Nopol: </p>
                            <p className="text-xs ml-1">{searchParams.get("noKendaraan")}</p></div>
