...
export default function LaporanPerTransporterPrint() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            if (!start || !end || !transporter) return;
            setLoading(true)
            try {
            ...
            {loading ? (
                ...
                <div>
                    <div ref={contentRef} className="print:p-8">
                        ...
                        <h2 className="text-2xl font-bold mb-4 text-center">Laporan Penimbangan per Transporter</h2>
                        <div className="flex">
                        ...
                        <div className="flex">
                            <p className="text-xs">Transporter: </p>
                            <p className="text-xs ml-1">{transporter}</p>
                        </div>
