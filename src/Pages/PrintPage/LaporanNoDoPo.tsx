...
export default function LaporanNoDoPoPrint() {
    const [searchParams] = useSearchParams();
    const noDoPo = searchParams.get("noDoPo");
            ...
            {loading ? (
                ...
                <div>
                    <div ref={contentRef} className="print:p-8">
                        ...
                        <div className="flex">
                            <p className="text-xs">No DO/PO: </p>
                            <p className="text-xs ml-1">{searchParams.get("noDoPo")}</p></div>
