...
export default function LaporanPerSupplierCustomerPrint() {
    const [searchParams] = useSearchParams();
    const supplierCustomer = searchParams.get("supplierCustomer");
    ...
    useEffect(() => {
        const fetchData = async () => {
            if (!start || !end || !supplierCustomer) return;
            setLoading(true)
            try {
            ...
            {loading ? (
                ...
                <div>
                    <div ref={contentRef} className="print:p-8">
                        ...
                        <div className="flex">
                            <p className="text-xs">Supplier/Customer: </p>
                            <p className="text-xs ml-1">{searchParams.get("supplierCustomer")}</p>
                        </div>
