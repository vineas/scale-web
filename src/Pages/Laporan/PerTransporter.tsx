...
import { getLaporanTransporter } from "../../Hooks/laporanPerTransporter";


export default function LaporanTransporter() {
    ...
    const handlePrint = async () => {
        ...
        window.open(`/transporter-print?start=${start}&end=${end}&transporter=${transporter}`, "_blank");
    };
    ...
    const handleExport = async () => {
        ...
        const data = await getLaporanTransporter(start, end, transporter);

        // Gunakan 'data' langsung, jangan pakai 'laporan'
        if (data && data.length > 0) {
            exportToExcel(data as Penimbangan[], "laporan_timbangan_per_transporter");
        } else {
            ...
            <div className="p-6 bg-white shadow-sm rounded-lg">
                ...
                <div className="flex items-center justify-center">
                    <div className="grid grid-cols-1 lg:grid-cols-1 md:grid-cols-1 xl:grid-cols-1 text-center">
                        <div></div>
                        {/* <div></div> */}
                        <h1 className="text-2xl font-bold text-gray-900">Laporan per Transporter</h1>
                    </div>
                </div>
                        ...
                        <div className="items-center justify-center mt-4 ">
                            <button
                                ...
                                className={`text-xs font-bold rounded-lg p-2 
                                    ${!transporter ? "bg-gray-400 cursor-not-allowed" : "text-white bg-blue-500 hover:bg-blue-200 hover:text-blue-500"}`}>
                            ...
                            <button
                                ...
                                className={`mt-3 sm:ml-4 md:ml-4 lg:ml-4 xl:ml-0 text-xs font-bold rounded-lg p-2
                                    ${!transporter ? "bg-gray-400 cursor-not-allowed" : "text-white bg-green-500 hover:bg-green-200 hover:text-green-500"}`}>
